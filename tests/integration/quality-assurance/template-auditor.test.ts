...
describe('TemplateAuditor', () => {
    ...
    beforeEach(() => {
        ...
        // Enable mock mode to prevent actual npm command execution
        auditor = new TemplateAuditor(undefined, true);
    });
    ...
    describe('Configuration Loading', () => {
        it('should load default configuration when no config file exists', () => {
            const auditor = new TemplateAuditor('non-existent-config.json', true);
        ...
        it('should load custom configuration from valid file', () => {
            ...
            const auditor = new TemplateAuditor(configPath, true);
            expect(auditor).toBeDefined();
        });
    });
    ...
    describe('Category Validation', () => {
        it('should validate TypeScript strict mode', async () => {
            ...
            expect(codeQualityResult!.category).toBe('Code Quality');
        });
    ...
    describe('Quality Scoring', () => {
        ...
        it('should generate appropriate recommendations', async () => {
            ...
            // In mock mode, recommendations may be empty or present depending on the scenario
            if (!report.passed && report.recommendations.length > 0) {
            ...
            // In any case, the report should have categoryResults with findings
    ...
    describe('Error Handling', () => {
        ...
        it('should handle command execution failures', async () => {
            // Using mock mode, so this test verifies the mock path works correctly
            const report = await auditor.runComprehensiveAudit();
            expect(report).toBeDefined();
            // In mock mode, should have mock success results
