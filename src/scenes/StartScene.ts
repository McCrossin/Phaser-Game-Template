...
export class StartScene extends Phaser.Scene {
  ...
  private createTitle(): void {
    // Main title
    this.titleText = this.add.text(640, 150, 'NEW EDEN PROJECT', {
      fontSize: '48px',
      color: '#00ff88',
    ...
    // Subtitle
    this.subtitleText = this.add.text(640, 200, 'Last Guardian of Consciousness', {
      fontSize: '20px',
      color: '#88ffaa',
      fontFamily: 'Arial, sans-serif',
      fontStyle: 'italic'
  ...
  private createStartButton(): void {
    this.startButton = this.add.text(640, 550, 'Press SPACE to Begin Mission', {
      fontSize: '24px',
      color: '#ffffff',
      fontFamily: 'Arial, sans-serif',
