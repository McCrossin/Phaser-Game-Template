...
**Generated**: Mon Jul 21 22:54:25 AEST 2025  
...
ERROR: Coverage for lines (2.15%) does not meet global threshold (80%)
ERROR: Coverage for functions (71.01%) does not meet global threshold (80%)
ERROR: Coverage for statements (2.15%) does not meet global threshold (80%)
...
============================================================
📅 Generated: 7/21/2025, 10:55:10 PM
...
✅ Build System: 30/30
   ...
   ✅ Build time within threshold (6021ms <= 30000ms)
   📦 Bundle size: 1.5M	dist
   📈 Metrics: {"buildTime":6021,"bundleSize":"1.5"}

✅ Test Suite: 20/25
   ✅ All tests passing
   ✅ Test execution within threshold (1916ms <= 60000ms)
   ℹ️ Coverage information not available
   📈 Metrics: {"testTime":1916}
...
============================================================
📅 Generated: 7/21/2025, 10:55:10 PM
📊 Found 1595 technical debt items
📁 Scanned 53 files
...
💡 RECOMMENDATIONS:
   ...
   🟡 MEDIUM: Consider refactoring to address 1343 medium-priority issues
   🟢 LOW: Schedule cleanup for 248 low-priority maintenance items
...
🔍 TOP ISSUES TO ADDRESS:
   ...
   🚨 tools/monitoring/technical-debt-tracker.ts:165 - Eval Usage
      💬 eval() can execute arbitrary code and is a security risk
      💡 Avoid eval() and use safer alternatives like JSON.parse() or proper parsing
      📝 Context: description: 'eval() can execute arbitrary code and is a security risk',

   🚨 tools/monitoring/technical-debt-tracker.ts:167 - Eval Usage
      💬 eval() can execute arbitrary code and is a security risk
      💡 Avoid eval() and use safer alternatives like JSON.parse() or proper parsing
...
- **Branch**: main
- **Commits**: 96
- **Last Commit**: a14b14c - Move stories to same location (32 minutes ago)
...
_Report saved to: `reports/health/health-report-2025-07-21_22-54-25.md`_
